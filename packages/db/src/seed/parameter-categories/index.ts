...
> => {
  ...
  const categories: {
    ...
    { name: "Faktor Fisika", clusterId: lingkunganHidupId.id },
    { name: "Faktor Kimia", clusterId: lingkunganHidupId.id },
    { name: "Faktor Mikrobiologi", clusterId: lingkunganHidupId.id },
    { name: "Faktor Kesehatan", clusterId: kesehatanKerjaId.id },
    { name: "KUDR", clusterId: biomarkerId.id },
    { name: "Pengujian Lain", clusterId: lingkunganKerjaId.id },
    { name: "Keselamatan", clusterId: keselamatanKerjaId.id },
  ];
