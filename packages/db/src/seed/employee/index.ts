...
async function seedEmployees(isProduction: boolean) {
  ...
  if (!isProduction) {
    const testEmployeeUsers: { email: string; roleName: string }[] = [
      ...
      { email: "lab-manager@mail.com", roleName: "koordinator_pengujian" },
      { email: "kaji-ulang@mail.com", roleName: "kaji_ulang" },
      { email: "head@mail.com", roleName: "kepala_balai" },
      { email: "admin-manager@mail.com", roleName: "koordinator_administrasi" },
      { email: "treasurer@mail.com", roleName: "bendahara" },
      { email: "penjadwalan@mail.com", roleName: "tim_penjadwalan" },
      { email: "equipment@mail.com", roleName: "tim_peralatan" },
