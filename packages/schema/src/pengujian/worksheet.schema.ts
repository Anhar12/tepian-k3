...
const reviseWorksheetSchema = z.object({
  worksheetId: z.uuidv7(),
...
const updateWorksheetPersonnelDateSetSchema = z.object({
  worksheetId: z.uuidv7(),
  isSet: z.boolean(),
});
...
// Borrow tools for worksheet (equipment officer selects individual physical tool units)
const borrowToolsFromWorksheetSchema = z.object({
  worksheetId: z.uuidv7(),
  items: z.array(
    z.object({
      itemId: z.uuidv7(),
...
// Return a single borrowed tool with condition check (equipment officer returns one tool at a time)
const returnToolsFromWorksheetSchema = z.object({
  worksheetId: z.uuidv7(),
...
const worksheetSchema = {
  ...
  reviseWorksheetSchema,
  verifyWorksheetSchema,
  updateWorksheetPersonnelDateSetSchema,
