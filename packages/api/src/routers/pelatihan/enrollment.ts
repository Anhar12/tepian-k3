...
export const enrollmentRouter = createTRPCRouter({
  getAllEnrollments: withPermission("pelatihan-enrollments.read")
    ...
    .query(async ({ input }) => {
      ...
      // ##################
      const queries = await import("@tepian-k3/queries/pelatihan/enrollment.queries").then(
        (m) => m.default,
      );
  ...
  getBimtekSchedules: protectedProcedure
    ...
    .query(async ({ ctx, input }) => {
      const scheduleQueries = await import("@tepian-k3/queries/pelatihan/schedule.queries").then(
        (m) => m.default,
      );
      return await runEffect(
  ...
  verifyEnrollment: withPermission("pelatihan-enrollments.verify")
    ...
    .mutation(async ({ ctx, input }) => {
      const enrollmentQueries = await import("@tepian-k3/queries/pelatihan/enrollment.queries").then(
        (m) => m.default,
      );
      return await runEffect(
