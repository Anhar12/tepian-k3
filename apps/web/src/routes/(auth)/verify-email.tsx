...
function VerifyEmailComponent() {
  ...
  const { data: verificationStatusData } = useQuery({
    ...
    enabled: !!email && (step === "otp" || step === "email"),
    refetchInterval: step === "otp" ? 3000 : false,
  });
  ...
  }, [verificationStatusData?.verificationStatus, step, navigate]);
  // ##################
  // end authored
  // ##################
            ...
            step === "otp" && (
              <Alert className="border-blue-200 bg-blue-50 text-blue-800">
                ...
                <AlertDescription className="text-blue-700">
                  Pendaftaran akun Anda sedang dalam antrean verifikasi. Anda
                  dapat menunggu verifikasi oleh administrator atau memasukkan
                  kode OTP di bawah ini untuk verifikasi instan.
                </AlertDescription>
              </Alert>
            )}
          ...
          {verificationStatusData?.verificationStatus === "rejected" && (
            ...
            >
              ...
              <AlertDescription className="text-red-700">
                ...
                <br />
                Silakan mendaftar kembali dengan data yang valid atau hubungi
                dukungan.
                <div className="mt-3">
                  <Button
                    variant="destructive"
                    size="sm"
                    className="h-8 rounded-md bg-red-600 font-semibold text-white hover:bg-red-700"
                    onClick={() => {
                      navigate({
                        to: "/register",
                        search: {
              ...
              <CardContent className="flex flex-col items-center gap-6 pt-10 pb-10 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-['Poppins'] text-[14px] text-[#64748B]">
                    {verificationStatusData?.verificationStatus === "approved"
                      ? "Akun Anda telah disetujui. Mengalihkan ke halaman masuk..."
                      : "Terima kasih telah memverifikasi email Anda. Mengalihkan ke dashboard..."}
                  </p>
                </div>
