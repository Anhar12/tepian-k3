...
export const Route = createFileRoute("/(core)/employee/worksheets/")({
  validateSearch: (search) => searchSchema.parse(search),
  beforeLoad: async ({ context }) =>
    await requirePermission(context, { permission: "worksheets.view" }),
  component: RouteComponent,
  head: () => pageHead("Worksheet Saya"),
});

/**
 * Employee worksheet list page showing worksheets the employee is assigned to.
 */
  ...
  return (
    <div className="flex flex-col gap-4">
      <WorksheetHeaderCard
        ...
        subtitle="Daftar worksheet pengujian laboratorium yang ditugaskan kepada Anda"
        actionButton={[]}
      />
