...
export const Route = createFileRoute("/(core)/employee/testings/")({
  validateSearch: (search) => searchSchema.parse(search),
  beforeLoad: async ({ context }) =>
    await requirePermission(context, { permission: "testing.view" }),
  component: RouteComponent,
  head: () => pageHead("Pengujian Saya"),
});
...
/**
 * Employee testings list page showing testing records the employee is involved in.
 */
function RouteComponent() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <WorksheetHeaderCard
        title="Pengujian Saya"
        subtitle="Daftar pengujian laboratorium yang melibatkan Anda"
        actionButton={[]}
      />
